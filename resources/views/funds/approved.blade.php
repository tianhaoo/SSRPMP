                    ...
                    <table class="table table-striped projects">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <a href="{{ route('fundsdetail') }}" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> 详情 </a>
                            <a href="{{ route('fundsedit') }}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> 编辑 </a>
                            <a href="{{ route('fundsdelete') }}}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> 删除 </a>
                          </td>
                        </tr>
                        <tr>
                          <td>#</td>
